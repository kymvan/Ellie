...
function template_do_before_content_sidebar_wrap(){
	...
	echo '<div class="wp-block-group alignfull has-background has-accent-2-background-color"><div class="wp-block-group__inner-container"><h1 class="has-accent-1-color has-text-color">'.get_the_title( get_option('page_for_posts', true) ).'</h1><p class="has-large-font-size has-accent-1-color has-text-color">Mental health tips and insights </p></div></div>';
